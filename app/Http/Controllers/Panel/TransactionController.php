...
class TransactionController extends Controller
{
    public function index()
    {
        ...
        return view('panel.transactions.index', compact('payers', 'transactions'));
    }
    ...
    public function create()
    {
        ...
        return view('panel.transactions.create', compact('payers'));
    }
    ...
    public function edit(Transaction $transaction)
    {
        ...
        return view('panel.transactions.edit', compact('payers', 'transaction'));
    }
