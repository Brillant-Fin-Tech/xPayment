...
class PayerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('panel.payers.index');
    }
    ...
    public function create()
    {
        ...
        return view('panel.payers.create');
    }
    ...
    public function store(StorePayerRequest $request)
    {
        ...
        return redirect()->route('panel.payers.index');
    }
    ...
    public function edit(Payer $payer)
    {
        ...
        return view('panel.payers.edit', compact('payer'));
    }
    ...
    public function show(Payer $payer)
    {
        ...
        return view('panel.payers.show', compact('payer'));
    }
