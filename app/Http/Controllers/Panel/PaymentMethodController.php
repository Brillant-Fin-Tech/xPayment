...
class PaymentMethodController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('panel.paymentMethods.index');
    }
    ...
    public function create()
    {
        ...
        return view('panel.paymentMethods.create');
    }
    ...
    public function store(StorePaymentMethodRequest $request)
    {
        ...
        return redirect()->route('panel.payment-methods.index');
    }
    ...
    public function edit(PaymentMethod $paymentMethod)
    {
        ...
        return view('panel.paymentMethods.edit', compact('paymentMethod'));
    }
    ...
    public function show(PaymentMethod $paymentMethod)
    {
        ...
        $paymentMethod->load('paymentMethodClientPaymentMethods');

        return view('panel.paymentMethods.show', compact('paymentMethod'));
    }
