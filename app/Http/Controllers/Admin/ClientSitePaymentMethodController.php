...
class ClientSitePaymentMethodController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.clientSitePaymentMethods.index', compact('client_payment_methods', 'client_sites'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.clientSitePaymentMethods.create', compact('client_payment_methods', 'client_sites'));
    }
    ...
    public function store(StoreClientSitePaymentMethodRequest $request)
    {
        ...
        return redirect()->route('admin.client-site-payment-methods.index');
    }
    ...
    public function edit(ClientSitePaymentMethod $clientSitePaymentMethod)
    {
        ...
        return view('admin.clientSitePaymentMethods.edit', compact('clientSitePaymentMethod', 'client_payment_methods', 'client_sites'));
    }
    ...
    public function show(ClientSitePaymentMethod $clientSitePaymentMethod)
    {
        ...
        return view('admin.clientSitePaymentMethods.show', compact('clientSitePaymentMethod'));
    }
