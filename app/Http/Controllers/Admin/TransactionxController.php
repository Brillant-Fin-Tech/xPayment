...
class TransactionxController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.transactionxes.index', compact('payers'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.transactionxes.create', compact('payers'));
    }
    ...
    public function edit(Transactionx $transactionx)
    {
        ...
        return view('admin.transactionxes.edit', compact('payers', 'transactionx'));
    }
