...
class ClientPaymentMethodController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.clientPaymentMethods.index', compact('clients', 'payment_methods'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.clientPaymentMethods.create', compact('clients', 'payment_methods'));
    }
    ...
    public function store(StoreClientPaymentMethodRequest $request)
    {
        ...
        return redirect()->route('admin.client-payment-methods.index');
    }
    ...
    public function edit(ClientPaymentMethod $clientPaymentMethod)
    {
        ...
        return view('admin.clientPaymentMethods.edit', compact('clientPaymentMethod', 'clients', 'payment_methods'));
    }
    ...
    public function show(ClientPaymentMethod $clientPaymentMethod)
    {
        ...
        return view('admin.clientPaymentMethods.show', compact('clientPaymentMethod'));
    }
