...
class ClientSiteTokenController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.clientSiteTokens.index', compact('client_sites'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.clientSiteTokens.create', compact('client_sites'));
    }
    ...
    public function store(StoreClientSiteTokenRequest $request)
    {
        ...
        return redirect()->route('admin.client-site-tokens.index');
    }
    ...
    public function edit(ClientSiteToken $clientSiteToken)
    {
        ...
        return view('admin.clientSiteTokens.edit', compact('clientSiteToken', 'client_sites'));
    }
    ...
    public function show(ClientSiteToken $clientSiteToken)
    {
        ...
        return view('admin.clientSiteTokens.show', compact('clientSiteToken'));
    }
