...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.payers.index') }}">
...
<div class="card">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="payer_transactionxes">
            @includeIf('admin.payers.relationships.payerTransactionxes', ['transactionxes' => $payer->payerTransactionxes])
        </div>
        <div class="tab-pane" role="tabpanel" id="payer_payer_sites">
            @includeIf('admin.payers.relationships.payerPayerSites', ['payerSites' => $payer->payerPayerSites])
        </div>
    </div>
</div>
