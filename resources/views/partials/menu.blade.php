        ...
        @can('payer_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/payers*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('payer_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.payers.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/payers") || request()->is("admin/payers/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
            ...
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/clients*") ? "c-show" : "" }} {{ request()->is("admin/client-payment-methods*") ? "c-show" : "" }} {{ request()->is("admin/client-sites*") ? "c-show" : "" }} {{ request()->is("admin/client-site-tokens*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('client_payment_method_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.client-payment-methods.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/client-payment-methods") || request()->is("admin/client-payment-methods/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('client_site_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.client-sites.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/client-sites") || request()->is("admin/client-sites/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
