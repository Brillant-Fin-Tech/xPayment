...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.payerSite.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("panel.payer-sites.update", [$payerSite->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="currency_code">{{ trans('cruds.payerSite.fields.currency_code') }}</label>
                <input class="form-control {{ $errors->has('currency_code') ? 'is-invalid' : '' }}" type="text" name="currency_code" id="currency_code" value="{{ old('currency_code', $payerSite->currency_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wallet_address') ? 'is-invalid' : '' }}" type="text" name="wallet_address" id="wallet_address" value="{{ old('wallet_address', $payerSite->wallet_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('base_currency_code') ? 'is-invalid' : '' }}" type="text" name="base_currency_code" id="base_currency_code" value="{{ old('base_currency_code', $payerSite->base_currency_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $payerSite->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $payerSite->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_kyc') ? 'is-invalid' : '' }}" type="text" name="customer_kyc" id="customer_kyc" value="{{ old('customer_kyc', $payerSite->customer_kyc) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('external_customer') ? 'is-invalid' : '' }}" type="text" name="external_customer" id="external_customer" value="{{ old('external_customer', $payerSite->external_customer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('response_url') ? 'is-invalid' : '' }}" type="text" name="response_url" id="response_url" value="{{ old('response_url', $payerSite->response_url) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('payer') ? 'is-invalid' : '' }}" name="payer_id" id="payer_id">
                    @foreach($payers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('payer_id') ? old('payer_id') : $payerSite->payer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('payer'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('site') ? 'is-invalid' : '' }}" name="site_id" id="site_id">
                    @foreach($sites as $id => $entry)
                        <option value="{{ $id }}" {{ (old('site_id') ? old('site_id') : $payerSite->site->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('site'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('payment_method') ? 'is-invalid' : '' }}" name="payment_method_id" id="payment_method_id">
                    @foreach($payment_methods as $id => $entry)
                        <option value="{{ $id }}" {{ (old('payment_method_id') ? old('payment_method_id') : $payerSite->payment_method->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
