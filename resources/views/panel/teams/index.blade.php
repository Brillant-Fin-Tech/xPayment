...
@can('team_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('panel.teams.create') }}">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($payment_methoods as $key => $item)
...
@can('team_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('panel.teams.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('panel.teams.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'payment_methood', name: 'payment_methoods.name' },
{ data: 'name', name: 'name' },
