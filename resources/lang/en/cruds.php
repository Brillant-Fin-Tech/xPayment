...
return [
    ...
    'clientSitePaymentMethod' => [
        'title'          => 'Client Site Payment Method',
        'title_singular' => 'Client Site Payment Method',
        'fields'         => [
            'id'                           => 'ID',
            'id_helper'                    => ' ',
            'client_payment_method'        => 'Client Payment Method',
            'client_payment_method_helper' => ' ',
            'client_site'                  => 'Client Site',
            'client_site_helper'           => ' ',
            'created_at'                   => 'Created at',
            'created_at_helper'            => ' ',
